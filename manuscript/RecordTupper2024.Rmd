...
To test for environmental associations with high or low occurrence of gelatinous taxa, we developed a species distribution model for each taxonomic group. We used environmental covariates from XYXYXcopernicus
...
optimizing AUC?(Fielding and Bell, 1997)AUC
was calculated using inbuilt tidymodels methods (Kuhn
and Wickham, 2020)

Hyperparameters.
Cross validation
Ensemble of runs used to quantify algorithmic uncertainty
Response curves used to understand associations with environmental covariates
