...
![Model output averaged into climatologies for the three taxa, showing January, April, July, and October (columns) for salps, coelenterates, and siphonophores (rows). The full climatology for each taxon is in the supplement (S2-S4).](./figscripts/salps-coel-siph_Jan-Apr-Jul-Oct_climatology.png)
...
![Figure S2. Model output climatology for salps.](./figscripts/salps_v1.02_monclim-NR.png)

![Figure S3. Model output climatology for coelenterates.](./figscripts/coel_v1.02_monclim-NR.png)

![Figure S4. Model output climatology for siphonophores](./figscripts/siph_v1.02_monclim-NR.png)
